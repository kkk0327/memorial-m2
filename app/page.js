...
const SCENE_CONFIG = {
  ...
  'Panorama02': {
    ...
    hotspots: [
      ...
      { type: 'nav', target: 'Panorama01', color: '#3b82f6', pitch: -22, yaw: -10, targetYaw: 180 } // 파란색 전면 배치
    ]
  },
  'Panorama03': {
    isOutdoor: true,
    ...
    hotspots: [
      ...
      { type: 'room', target: 'bong02', text: '봉안당 2', pitch: 10, yaw: 10 },
      { type: 'nav', target: 'Panorama04', color: '#ef4444', pitch: -10, yaw: 5, targetYaw: 0 },
      { type: 'nav', target: 'Panorama02', color: '#3b82f6', pitch: -15, yaw: -5, targetYaw: 180 } // 파란색 전면 배치
    ]
  },
  'Panorama04': { // 핵심 분기점 리뉴얼
    isOutdoor: true,
    ...
    hotspots: [
      ...
      { type: 'nav', target: 'Panorama07', color: '#ef4444', pitch: -15, yaw: 15, targetYaw: 0 }, // 빨간색 (7번행)
      { type: 'nav', target: 'Panorama06', color: '#10b981', pitch: -15, yaw: -15, targetYaw: 0 }, // 녹색 (6번행)
      { type: 'nav', target: 'Panorama03', color: '#3b82f6', pitch: -20, yaw: 0, targetYaw: 180 } // 파란색 (3번행)
    ]
  },
  'Panorama06': {
    isOutdoor: true,
    ...
    hotspots: [
      ...
      { type: 'nav', target: 'Panorama04', color: '#3b82f6', pitch: -15, yaw: 0, targetYaw: 160 }
    ]
  },
  'Panorama07': {
    isOutdoor: true,
    ...
    hotspots: [
      ...
      { type: 'nav', target: 'Panorama08', color: '#ef4444', pitch: -10, yaw: 5, targetYaw: 0 },
      { type: 'nav', target: 'Panorama04', color: '#3b82f6', pitch: -15, yaw: -5, targetYaw: -135 }
    ]
  },
  'Panorama08': {
    isOutdoor: true,
    ...
    hotspots: [
      ...
      { type: 'nav', target: 'Panorama07', color: '#3b82f6', pitch: -15, yaw: 0, targetYaw: -150 }
    ]
  },
  // ... 세부 실내 공간 설정 ...
...
export default function MemorialApp() {
  ...
  const handleExit = () => {
    if (SCENE_CONFIG[currentScene]?.isOutdoor) { setActiveMenu('main'); }
    else { setCurrentScene('Panorama01'); }
  };
